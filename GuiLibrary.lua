if shared.VapeExecuted then
	...
	GuiLibrary["CreateMainWindow"] = function()
		...
		windowlogo1.Size = UDim2.new(0, 80, 0, 23)
		...
		settingsbox2.Name = "VERSION"
		settingsbox2.Size = UDim2.new(1, 0, 0, 40)
		settingsbox2.Position = UDim2.new(0, 0, 1, -43)
		...
		settingsbox2.TextColor3 = Color3.new(255, 255, 255)
		settingsbox2.ZIndex = 3
		settingsbox2.Visible = true
		local settingsbox3 = Instance.new("Frame")
		settingsbox3.ZIndex = 3
		settingsbox3.Size = UDim2.new(1, 0, 1, 0)
		...
		windowapi["CreateDivider"] = function(text)
			...
			local dividerlabel
			if text then
				dividerlabel = Instance.new("TextLabel")
		...
		windowapi["CreateDivider2"] = function(text)
			...
			if text then
				...
				windowapi3["CreateSlider"] = function(argstable)
					...
					slider1.Size = UDim2.new(0, 200, 0, 7)
					...
					slider3.Position = UDim2.new(1, -11, 0, -5)
		...
		windowapi["CreateColorSlider"] = function(name, temporaryfunction, num2)
			...
			if num2 then 
				GuiLibrary.ObjectsThatCanBeSaved["Gui ColorSliderColor2"] = {["Type"] = "ColorSliderGUI", ["Object"] = frame, ["Api"] = sliderapi} 
			else
		...
		windowapi["CreateToggle"] = function(argstable, custom)
			print(argstable["Name"])
			local buttonapi = {}
			local currentanim
			local amount
			if custom then
				amount = #children:GetChildren()
			else
				amount = #children2:GetChildren()
			end
			local buttontext = Instance.new("TextButton")
			buttontext.AutoButtonColor = false
			buttontext.BackgroundTransparency = 1
			...
			buttonapi["ToggleButton"] = function(clicked, first)
				--if overlaysbkg.Visible == false then
					...
					if buttonapi["Enabled"] then
						...
						buttontext.TextColor3 = Color3.new(255, 255, 255)
						if not first then
		...
		windowapi["CreateDropdown"] = function(argstable)
			...
			local amount2 = #children:GetChildren()
			local frame = Instance.new("Frame")
			frame.Size = UDim2.new(0, 220, 0, 40)
			frame.BackgroundTransparency = 1
			frame.LayoutOrder = amount2
		...
		windowapi["CreateOptionsButton"] = function(argstablemain)
			...
			buttonapi["ToggleButton"] = function(clicked, toggle)
				...
				if buttonapi["Enabled"] then
					...
					bindimg.ImageColor3 = Color3.fromRGB(255, 255, 255)
				else
	...
	GuiLibrary["CreateWindow"] = function(argstablemain2)
		...
		windowapi["ExpandToggle"] = function()
			windowapi["Expanded"] = not windowapi["Expanded"]
